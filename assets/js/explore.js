...
(function () {
  ...
  /* ------------------------------------------------------------------
     Hotspot data — positions are % of the aerial plate (1600×1100 canvas)
  ------------------------------------------------------------------ */
  var SPOTS = [
    {
      id: "resort", cat: "stay", x: 62.0, y: 26.6, name: "The Resort",
    ...
    {
      id: "spa", cat: "well", x: 60.4, y: 26.7, name: "Mokara Spa",
      title: "Mokara Spa",
    ...
    {
      id: "foothills", cat: "golf", x: 57.5, y: 16.5, name: "Fazio Foothills",
    ...
    {
      id: "canyons", cat: "golf", x: 34.4, y: 73.9, name: "Fazio Canyons",
      title: "Fazio Canyons",
    ...
    {
      id: "crenshaw", cat: "golf", x: 66.3, y: 43.3, name: "Coore Crenshaw",
    ...
    {
      id: "academy", cat: "golf", x: 56.5, y: 20.6, name: "Golf Academy",
    ...
    {
      id: "bobs", cat: "dine", x: 63.1, y: 25.2, name: "Bob's Steak & Chop House",
    ...
    {
      id: "salamander", cat: "dine", x: 61.2, y: 28.0, name: "Blind Salamander",
    ...
    {
      id: "overlook", cat: "dine", x: 63.6, y: 28.7, name: "The Overlook Terrace",
    ...
    {
      id: "infinity", cat: "well", x: 62.2, y: 24.3, name: "Infinity Edge Pool",
    ...
    {
      id: "familypool", cat: "play", x: 59.3, y: 24.8, name: "Family Pool & Splash Pad",
    ...
    {
      id: "kidzone", cat: "play", x: 58.3, y: 25.8, name: "Barton's Kid Zone",
    ...
    {
      id: "tennis", cat: "play", x: 58.2, y: 22.7, name: "Tennis & Pickleball",
      title: "Racquet Club",
    ...
    {
      id: "trails", cat: "play", x: 69.5, y: 21.5, name: "Greenbelt Trailhead",
    ...
    {
      id: "creek", cat: "play", x: 71.5, y: 36.5, name: "Barton Creek",
    ...
    {
      id: "pavilion", cat: "stay", x: 60.6, y: 28.7, name: "Event Lawn & Pavilion",
    ...
    {
      id: "residences", cat: "stay", x: 63.2, y: 16.6, name: "The Residences",
    ...
    {
      id: "lakeside", cat: "golf", x: 13.4, y: 14.6, name: "Palmer Lakeside · Lake Travis",
  ...
  var MIN_SCALE = 0.7, MAX_SCALE = 2.8;
  ...
  function clampView() {
    ...
    // Pan with slack while the plate overflows; keep it centered once it fits.
    var maxX = w > window.innerWidth ? (w - window.innerWidth) / 2 + 120 * target.scale : 24;
    var maxY = h > window.innerHeight ? (h - window.innerHeight) / 2 + 120 * target.scale : 24;
  ...
  function render() {
    ...
    pinLayer.style.setProperty("--pinscale", (1 / view.scale).toFixed(4));
  ...
  function focusOn(px, py, scale) {
    target.scale = scale;
    target.x = -(px / 100 - 0.5) * 1600 * scale;
    target.y = -(py / 100 - 0.5) * 1100 * scale;
    clampView();
  }
  ...
  document.querySelectorAll("[data-enter-map]").forEach(function (btn) {
    btn.addEventListener("click", function () {
      ...
      focusOn(61.5, 26.5, window.innerWidth < 760 ? 1.95 : 1.45);
      setTimeout(function () {
        if (hint) {
